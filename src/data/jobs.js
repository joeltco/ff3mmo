...
export const JOBS = [
  // idx  name             weapons                                          armor                        magic            maxMagicLv
  { name: 'Onion Knight', weapons: WPN_ALL,                                armor: ARM_ALL,              magic: 0,         maxMagicLv: 0 },
  { name: 'Fighter',      weapons: WPN_SWORD | WPN_KNIFE | WPN_AXE,        armor: ARM_ALL,              magic: 0,         maxMagicLv: 0 },
  { name: 'Monk',         weapons: WPN_CLAW,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0 },
  { name: 'White Mage',   weapons: WPN_STAFF | WPN_ROD,                    armor: ARM_LIGHT,            magic: MAG_WHITE, maxMagicLv: 7 },
  { name: 'Black Mage',   weapons: WPN_KNIFE | WPN_ROD,                    armor: ARM_LIGHT,            magic: MAG_BLACK, maxMagicLv: 7 },
  { name: 'Red Mage',     weapons: WPN_SWORD | WPN_STAFF | WPN_ROD,        armor: ARM_ALL,              magic: MAG_WHITE | MAG_BLACK, maxMagicLv: 4 },
  { name: 'Ranger',       weapons: WPN_BOW,                                armor: ARM_LIGHT,            magic: MAG_WHITE, maxMagicLv: 3 },
  { name: 'Knight',       weapons: WPN_SWORD | WPN_KNIFE | WPN_AXE,        armor: ARM_ALL,              magic: 0,         maxMagicLv: 0 },
  { name: 'Thief',        weapons: WPN_SWORD | WPN_KNIFE,                  armor: ARM_ALL,              magic: 0,         maxMagicLv: 0 },
  { name: 'Scholar',      weapons: WPN_BOOK,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0 },
  { name: 'Geomancer',    weapons: WPN_BELL,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0 },
  { name: 'Dragoon',      weapons: WPN_SPEAR,                              armor: ARM_ALL,              magic: 0,         maxMagicLv: 0 },
  { name: 'Viking',       weapons: WPN_AXE,                                armor: ARM_ALL,              magic: 0,         maxMagicLv: 0 },
  { name: 'Black Belt',   weapons: WPN_CLAW,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0 },
  { name: 'Magic Knight', weapons: WPN_KATANA,                             armor: ARM_ALL,              magic: MAG_WHITE, maxMagicLv: 3 },
  { name: 'Conjurer',     weapons: WPN_ROD,                                armor: ARM_LIGHT,            magic: MAG_CALL,  maxMagicLv: 8 },
  { name: 'Bard',         weapons: WPN_HARP,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0 },
  { name: 'Summoner',     weapons: WPN_ROD,                                armor: ARM_LIGHT,            magic: MAG_CALL,  maxMagicLv: 8 },
  { name: 'Devout',       weapons: WPN_STAFF | WPN_ROD,                    armor: ARM_LIGHT,            magic: MAG_WHITE, maxMagicLv: 8 },
  { name: 'Magus',        weapons: WPN_ROD,                                armor: ARM_LIGHT,            magic: MAG_BLACK, maxMagicLv: 8 },
  { name: 'Sage',         weapons: WPN_ROD | WPN_STAFF | WPN_BOOK,         armor: ARM_LIGHT,            magic: MAG_WHITE | MAG_BLACK | MAG_CALL, maxMagicLv: 8 },
  { name: 'Ninja',        weapons: WPN_ALL,                                armor: ARM_ALL,              magic: 0,         maxMagicLv: 0 },
];
