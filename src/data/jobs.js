...
export const JOBS = [
  ...
  { name: 'Onion Knight', weapons: WPN_SWORD | WPN_KNIFE | WPN_BOW | WPN_ARROW, armor: ARM_ALL,           magic: 0,         maxMagicLv: 0, alignment: 0x88, lvReq:  0 },
  { name: 'Fighter',      weapons: WPN_SWORD | WPN_KNIFE | WPN_BOW | WPN_ARROW, armor: ARM_ALL,          magic: 0,         maxMagicLv: 0, alignment: 0x79, lvReq:  0 },
  { name: 'Monk',         weapons: 0,                                      armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0, alignment: 0x77, lvReq:  0 },
  { name: 'White Mage',   weapons: WPN_STAFF | WPN_ROD,                    armor: ARM_LIGHT,            magic: MAG_WHITE, maxMagicLv: 7, alignment: 0x99, lvReq:  0 },
  { name: 'Black Mage',   weapons: WPN_KNIFE | WPN_ROD,                    armor: ARM_LIGHT,            magic: MAG_BLACK, maxMagicLv: 7, alignment: 0x97, lvReq:  0 },
  { name: 'Red Mage',     weapons: WPN_SWORD | WPN_KNIFE | WPN_BOW | WPN_STAFF | WPN_ROD | WPN_ARROW, armor: ARM_ALL, magic: MAG_WHITE | MAG_BLACK, maxMagicLv: 4, alignment: 0x8A, lvReq:  0 },
  { name: 'Ranger',       weapons: WPN_BOW,                                armor: ARM_LIGHT,            magic: MAG_WHITE, maxMagicLv: 3, alignment: 0x7B, lvReq:  9 },
  { name: 'Knight',       weapons: WPN_SWORD | WPN_KNIFE | WPN_BOOMERANG,   armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, alignment: 0x8C, lvReq:  9 },
  { name: 'Thief',        weapons: WPN_KNIFE | WPN_BOOMERANG,              armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, alignment: 0x75, lvReq:  9 },
  { name: 'Scholar',      weapons: WPN_BOOK,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0, alignment: 0xAA, lvReq:  9 },
  { name: 'Geomancer',    weapons: WPN_BELL,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0, alignment: 0xA4, lvReq: 14 },
  { name: 'Dragoon',      weapons: WPN_SPEAR,                              armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, alignment: 0x5B, lvReq: 14 },
  { name: 'Viking',       weapons: WPN_AXE,                                armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, alignment: 0x55, lvReq: 14 },
  { name: 'Black Belt',   weapons: WPN_CLAW,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0, alignment: 0x28, lvReq: 14 },
  { name: 'Magic Knight', weapons: WPN_KATANA | WPN_SWORD | WPN_BOOMERANG,  armor: ARM_ALL,              magic: MAG_WHITE, maxMagicLv: 3, alignment: 0x82, lvReq: 14 },
  { name: 'Conjurer',     weapons: WPN_ROD,                                armor: ARM_LIGHT,            magic: MAG_CALL,  maxMagicLv: 8, alignment: 0xD8, lvReq: 14 },
  { name: 'Bard',         weapons: WPN_HARP,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0, alignment: 0xBB, lvReq: 14 },
  { name: 'Summoner',     weapons: WPN_ROD,                                armor: ARM_LIGHT,            magic: MAG_CALL,  maxMagicLv: 8, alignment: 0xC4, lvReq: 29 },
  { name: 'Devout',       weapons: WPN_STAFF | WPN_ROD,                    armor: ARM_LIGHT,            magic: MAG_WHITE, maxMagicLv: 8, alignment: 0xCC, lvReq: 29 },
  { name: 'Magus',        weapons: WPN_ROD,                                armor: ARM_LIGHT,            magic: MAG_BLACK, maxMagicLv: 8, alignment: 0xF0, lvReq: 29 },
  { name: 'Sage',         weapons: WPN_ROD | WPN_STAFF | WPN_BOOK,         armor: ARM_LIGHT,            magic: MAG_WHITE | MAG_BLACK | MAG_CALL, maxMagicLv: 8, alignment: 0xFF, lvReq: 39 },
  { name: 'Ninja',        weapons: WPN_ALL,                                armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, alignment: 0x00, lvReq: 39 },
];
