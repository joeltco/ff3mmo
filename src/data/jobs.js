...
export const JOBS = [
  ...
  { name: 'Onion Knight', weapons: WPN_ALL,                                armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, cpCost: 0  },
  { name: 'Fighter',      weapons: WPN_SWORD | WPN_KNIFE | WPN_AXE,        armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, cpCost: 10 },
  { name: 'Monk',         weapons: WPN_CLAW,                               armor: ARM_LIGHT,            magic: 0,         maxMagicLv: 0, cpCost: 10 },
  ...
  { name: 'Red Mage',     weapons: WPN_SWORD | WPN_STAFF | WPN_ROD,        armor: ARM_ALL,              magic: MAG_WHITE | MAG_BLACK, maxMagicLv: 4, cpCost: 10 },
  { name: 'Ranger',       weapons: WPN_BOW,                                armor: ARM_LIGHT,            magic: MAG_WHITE, maxMagicLv: 3, cpCost: 20 },
  { name: 'Knight',       weapons: WPN_SWORD | WPN_KNIFE | WPN_AXE,        armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, cpCost: 20 },
  { name: 'Thief',        weapons: WPN_SWORD | WPN_KNIFE,                  armor: ARM_ALL,              magic: 0,         maxMagicLv: 0, cpCost: 20 },
  ...
  { name: 'Magic Knight', weapons: WPN_KATANA,                             armor: ARM_ALL,              magic: MAG_WHITE, maxMagicLv: 3, cpCost: 30 },
