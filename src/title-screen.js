...
const TITLE_CREDIT_1  = new Uint8Array([0x8A,0xFF,0xA9,0xA4,0xB1,0xFF,0xAA,0xA4,0xB0,0xA8]);
const TITLE_CREDIT_2  = new Uint8Array([0xB0,0xA4,0xA7,0xA8,0xFF,0xA5,0xBC]);
const TITLE_CREDIT_3  = new Uint8Array([0x93,0xB2,0xA8,0xAF,0xB7,0x8C,0xB2]);
const TITLE_DISCLAIM_1 = new Uint8Array([0x8A,0xAF,0xAF,0xFF,0xA6,0xAB,0xA4,0xB5,0xA4,0xA6,0xB7,0xA8,0xB5,0xB6]);
const TITLE_DISCLAIM_2 = new Uint8Array([0xA4,0xB1,0xA7,0xFF,0xB0,0xB8,0xB6,0xAC,0xA6,0xFF,0xA4,0xB5,0xA8]);
const TITLE_DISCLAIM_3 = new Uint8Array([0xB3,0xB5,0xB2,0xB3,0xA8,0xB5,0xB7,0xBC,0xFF,0xB2,0xA9]);
const TITLE_DISCLAIM_4 = new Uint8Array([0x9C,0x9A,0x9E,0x8A,0x9B,0x8E,0xFF,0x8E,0x97,0x92,0xA1]);
const TITLE_DISCLAIM_5 = new Uint8Array([0x97,0xB2,0xFF,0xA4,0xA9,0xA9,0xAC,0xAF,0xAC,0xA4,0xB7,0xAC,0xB2,0xB1]);
