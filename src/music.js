...
export const SFX = {
  ...
  DEFEND_HIT:   0x61,  // SFX $20 + $41 — defend action sound (confirmed by user)  [MEASURED v1.7.873 — Safe (0x1a) capture, $A0].  [SETTLED v1.7.877 — v1.7.875 wondered aloud whether this belonged to the Run row and Guard's real sound was 135 ($c6), off one sighting each. Measured properly in an unkillable/harmless sandbox battle: across 25 Guard rounds $c6 NEVER appears and neither does $a0 — FF3's Guard row plays no sound of its own. $a0 shows up only under Run, twice, beside the one escape. So the 135 idea is refuted and this constant is NOT moving: its $A0 measurement is the Safe spell's impact (a real capture of a different event), and DEFEND_HIT is OUR cue for OUR defend command. See BATTLE_ROW_SOUNDS in data/world-sfx-captured.js.]
