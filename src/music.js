...
export const SFX = {
  ...
  CONFIRM:      0x46,  // SFX $05 + $41 — menu confirm.  [ATTRIBUTED v1.8.5 — 59 occurrences in one battle run, exactly one per command pick, none on a row that does nothing.]
  ...
  ATTACK_HIT:   0x71,  // SFX $30 + $41 — a MONSTER hitting a PARTY MEMBER.  [ATTRIBUTED v1.8.5 — the screenshot at the write reads "Goblin" over "FFFKKK". It fired ZERO times in two runs where the party won untouched and 4 times once the goblin was armed (build-capture-rom.cjs --dangerous); that contrast is the measurement. ff3mmo uses it as the BLUNT-weapon hit — our choice, see KNIFE_HIT.]
  KNIFE_HIT:    0x77,  // SFX $36 + $41 — a PARTY MEMBER hitting a MONSTER.  [ATTRIBUTED v1.8.5 — screenshot reads "PUUUUU" over "Goblin" with "1xHit", party undamaged.  ⚠ THE NAME IS MISLEADING: FF3 splits these two sounds by WHO HITS WHOM, not by weapon. ff3mmo uses KNIFE_HIT/ATTACK_HIT as bladed/blunt (src/battle-sfx.js#10) — a deliberate choice between two real FF3 hit sounds. Don't read the name as provenance, and don't "fix" the usage. Earlier notes had this backwards, calling it the monster's hit.]
  MONSTER_DEATH: 0x72, // SFX $31 + $41 — a monster dying.  [ATTRIBUTED v1.8.5 — fires 64 frames after the killing hit, and the follow-up frame has one fewer goblin on screen.]
