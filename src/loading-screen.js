...
function _drawLoadingChatBubble(rpCX, rpY, rpH, fadeLevel) {
  ...
  const bossBytes = new Uint8Array([0x8B,0xB2,0xB6,0xB6,0xFF,0x94,0xB8,0xB3,0xB2,0xC4]);
  let fadedWhite = 0x30;
...
export function drawLoadingOverlay() {
  ...
  const promptBytes = isMobile
    ? new Uint8Array([0x99,0xB5,0xA8,0xB6,0xB6,0xFF,0x8A])
    : new Uint8Array([0x99,0xB5,0xA8,0xB6,0xB6,0xFF,0xA3]);
