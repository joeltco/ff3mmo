...
export const STATUS_NAME_BYTES = {
  [STATUS.PARALYSIS]: new Uint8Array([0x99,0xA4,0xB5,0xA4,0xAF,0xBC,0xE5,0xA8,0xA7]), // Paralyzed
  [STATUS.POISON]:    new Uint8Array([0x99,0xB2,0xAC,0xB6,0xB2,0xB1,0xA8,0xA7]),       // Poisoned
  [STATUS.BLIND]:     new Uint8Array([0x8B,0xAF,0xAC,0xB1,0xA7,0xA8,0xA7]),             // Blinded
  [STATUS.SILENCE]:   new Uint8Array([0x9C,0xAC,0xAF,0xA8,0xB1,0xA6,0xA8,0xA7]),       // Silenced
  [STATUS.PETRIFY]:   new Uint8Array([0x99,0xA8,0xB7,0xB5,0xAC,0xA9,0xAC,0xA8,0xA7]), // Petrified
  [STATUS.SLEEP]:     new Uint8Array([0x8A,0xB6,0xAF,0xA8,0xA8,0xB4]),                 // Asleep
  [STATUS.CONFUSE]:   new Uint8Array([0x8C,0xB2,0xB1,0xA9,0xB8,0xB6,0xA8,0xA7]),       // Confused
};
