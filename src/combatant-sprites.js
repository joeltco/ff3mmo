...
import { PLAYER_PALETTES, MONK_PALETTES, BLACK_MAGE_PALETTES, RED_MAGE_PALETTES, ROSTER_FADE_STEPS } from './data/players.js';
...
function _genericBundle(romData, jobIdx) {
  ...
  return {
    ...
    palettes: jobIdx === 4 ? BLACK_MAGE_PALETTES : jobIdx === 5 ? RED_MAGE_PALETTES : PLAYER_PALETTES,
