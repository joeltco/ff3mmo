...
// Poison bubble animation — 2-frame 16×8 sprite (side by side) from ROM $56A50
// Frame 1: A($56A50) left + B($56A60) right
// Frame 2: C($56A70) left + D($56A80) right
...
const POISON_FRAME_TILES = [
  [new Uint8Array([0xf0,0xf8,0x7c,0x3e,0x3e,0x3f,0x7f,0x7f, 0x00,0xf0,0xf8,0xfc,0xfc,0xfe,0xfe,0xfe]),  // A (left)
   new Uint8Array([0xff,0x7e,0x3e,0x1f,0x07,0x0f,0x1f,0x18, 0x7f,0x3f,0x1f,0x07,0x03,0x07,0x08,0x00])],  // B (right)
  [new Uint8Array([0xff,0x7e,0x7c,0xf8,0xf0,0x80,0x00,0x00, 0xfe,0xfc,0xf8,0xf0,0x80,0x00,0x00,0x00]),  // C (left)
   new Uint8Array([0x07,0x1f,0x3f,0x7e,0x7e,0xfe,0xfe,0xfe, 0x00,0x07,0x1f,0x3f,0x3f,0x7f,0x7f,0x7f])],  // D (right)
];
