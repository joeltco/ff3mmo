# Changelog — pre-1.6.0 history

Archived from `CHANGELOG.md` for browsability. `1.6.0` (2026-04-18) was the refactor-complete waypoint where game.js dropped to 912L and shared-bag patterns were eliminated; entries before that point land here.

Entries are in reverse-chronological order, same as the main CHANGELOG.
